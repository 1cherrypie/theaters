...
?>	
			...
			<div class="some-container">
					<div class="content-container-contacts">
						<h3 class="theaters-title1">Контакты</h3>
						<div class="block-contacts">
						<div class="block_contacts">
						<h4 class="contacts-paragraph">Телефон:</h4>
						<p>8(996)775-30-58</p>
						<h4 class="contacts-paragraph">@-mail:</h4>
						<p>kristya-ulybochka@mail.ru</p>
						<h4 class="contacts-paragraph">Социальные сети:</h4>
						<ul class="contacts-list">
							<li><h5>Вконтактик:</h5></li>
							<a class="contacts-link" href="https://vk.com/id113300633">vk.com/id113300633</a>
							<li><h5>Инстаграммчик:</h5></li>
							<a class="contacts-link" href="https://www.instagram.com/1cherry_pie">www.instagram.com/1cherry_pie</a>
						</ul>
						<h4 class="contacts-paragraph"><a class="contacts-link" href="kassa.php">Театральные кассы</a></h4>
					</div>
					</div>
					</div>
				</div>
